# README
このリポジトリはDeviseによる認証の個人学習用のものです。
サンプルプログラムにDeviseを導入し、アカウント登録やサインインといった機能の追加方法を確認しています。
...
- Deviseは[Warden](https://github.com/wardencommunity/warden)ベース 
  ...
  - Recoverable モジュールを有効にしている場合、ログレベルの設定がデフォルトのままだとパスワードリセット用のトークンが平文でリークする恐れがある
